...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  const [goldPrice] = useState(2045.50);
  ...
  const addTransaction = (transaction: Omit<Transaction, "id" | "date">) => {
    // Calculate GSAP: 1 point = 1 gram of metal purchased
    // Convert oz to grams (1 oz = 31.1035 grams)
    const gramsPerOz = 31.1035;
    const pointsEarned = transaction.type === "buy" ? Math.floor(transaction.amount * gramsPerOz) : 0;
